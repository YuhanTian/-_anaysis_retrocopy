#RandomizedTEST2
RandomizedTEST2 <- function(contacts,retro){
  ...
  for(i in 1:1000)
  {
    ...
    shuffleR_pairs <- GenomicInteractions(shuffle_gp_pairs1, gp_pairs2, counts=1)
    paired_hits<-findOverlaps(shuffleR_pairs,contacts)
